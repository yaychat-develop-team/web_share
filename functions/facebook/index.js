...
function getCanonicalShareHostname(hostname) {
  return hostname
    .replace(/^test\.share\./i, '')
    .replace(/^share\./i, '')
}
...
export function onRequest({ request }) {
  ...
  const canonicalSiteName = getCanonicalShareHostname(url.hostname)
...
<head>
  ...
  <meta property="og:site_name" content="${escapeHtml(canonicalSiteName)}">
